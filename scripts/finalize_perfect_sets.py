"""Ajuste quirúrgico final: 0% duplicados y 73-78.5 min en los 16 sets."""
...
PERFECT_16_SETS = {
    ...
    "Set 7 - Trance & Progressive Euphoria (Side B)": [
        "Motorcycle - As The Rush Comes", "For An Angel", "Airwave", "Serenity",
    ...
    "Set 4 - House Divas & Club Classics (Side A)": [
        ...
        "Beautiful People", "Free (Mood II Swing", "The Bucketheads - The Bomb",
    ...
    "Set 8 - Soulful House & Vocal Legends (Side B)": [
        ...
        "Black Box - Ride On Time", "Closer Than Close",
    ...
    "Set 9 - Progressive House & Stadium Melodic (Side A)": [
        "Deadmau5 Kaskade I Remember", "Eric Prydz Pjanoo", "Swedish House Mafia One",
        "Leave The World Behind", "Tim Berg Seek Bromance", "Adrian Lux Teenage Crime",
        "Guru Josh Project Infinity 2008", "Kaskade Move For Me", "Afrojack Take Over Control",
        "Sebastian Ingrosso Kidsos", "John Dahlback Pyramid", "Reflekt Need To Feel Loved",
        "Deadmau5 Ghosts n Stuff", "Dirty South Walking Alone"
    ],
    "Set 13 - Progressive House & Deep Anthems (Side B)": [
        "Deadmau5 Strobe", "Proper Education", "Axwell I Found U", "David Guetta Love Is Gone",
        "Sander van Doorn Riff", "Steve Angello Knas", "Swedish House Mafia Miami 2 Ibiza",
        "Paul Kalkbrenner Sky and Sand", "Klaas Our Own Way", "Fedde Le Grand 3 Minutes To Explain",
        "Dirty South Open Your Heart", "Kaskade Dynasty", "Eric Prydz Call On Me"
    ],

    # VOL 6: French Electro & Bloghouse Anthems
    "Set 10 - French Electro & Bloghouse (Side A)": [
        "Justice D.A.N.C.E.", "Bloody Beetroots Warp 1.9", "Kid Cudi Day n Nite", "Boys Noize and Down",
        "Simian Mobile Disco Hustler", "MSTRKRFT Heartbreaker", "Chuckie Let The Bass Kick", "Afrojack Polkadots",
        "Major Lazer Pon De Floor", "Sidney Samson Riverside", "Bingo Players Cry Just a Little", "Fake Blood Mars",
        "Wolfgang Gartner Illmerica", "Dada Life Kick Out The Epic", "Justice Genesis", "Boys Noize Oi Oi Oi",
        "Uffie Pop The Glock"
    ],
    "Set 14 - Dirty Dutch & Club Bilde (Side B)": [
        "Justice Simian We Are Your Friends", "Yeah Yeah Yeahs Heads Will Roll", "Duck Sauce Barbra Streisand",
        "Martin Solveig Dragonette Hello", "Mr Oizo Positif", "Kavinsky Nightcall", "Duck Sauce aNYway",
        "Digitalism Pogo", "Vitalic Poison Lips", "Chemical Brothers Hey Boy Hey Girl", "Congorock Babylon",
        "Laidback Luke Steve Aoki Turbulence", "Sebastian Motor Original"
    ],
...
async def finalize_perfect_sets():
    for name, track_list in PERFECT_16_SETS.items():
...
if __name__ == "__main__":
    asyncio.run(finalize_perfect_sets())
