"""Generador y verificador definitivo de 16 Sets con CERO duplicados y duraciones optimizadas."""
...
# Mapeo exacto usando artistas y títulos de library/
EXACT_SETS = {
    ...
    "Set 6 - Electro & Dirty Club Anthems (Side B)": [
        ...
        "Camille Jones vs Fedde Le Grand - The Creeps", "Outwork ft. Mr. Gee - Elektro",
        "Dave Spoon - At Night", "TV Rock ft. Seany B - Flaunt It", "Spektrum - Kinda New",
        "Enur ft. Natasja - Calabria 2007", "Uniting Nations - Out Of Touch", "Sunset Strippers - Falling Stars",
        "Hi_Tack - Say Say Say", "Supermode - Tell Me Why", "Freaks - The Creeps", "Studio B - I See Girls"
    ],
    ...
    "Set 8 - Soulful House & Vocal Legends (Side B)": [
        ...
        "Juliet Roberts - Caught In The Middle", "Alison Limerick - Where Love Lives",
        "Livin Joy - Dreamer", "Black Box - Ride On Time", "Rosie Gaines - Closer Than Close",
    ...
    "Set 13 - Progressive House & Deep Anthems (Side B)": [
        ...
        "Kaskade - Dynasty", "Steve Angello & Laidback Luke - Show Me Love"
    ],
    ...
    "Set 14 - Dirty Dutch & Club Bilde (Side B)": [
        ...
        "Laidback Luke & Steve Aoki - Turbulence", "SebastiAn - Motor"
    ],
...
async def generate_and_audit():
    print("=== Generando los 16 Sets con Mapeo Exacto de Archivos ===")
    for name, track_list in EXACT_SETS.items():
...
if __name__ == "__main__":
    asyncio.run(generate_and_audit())
