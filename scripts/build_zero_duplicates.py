"""Constructor maestro para 16 Sets con CERO duplicados y calibración a 80 min."""
...
SETS_100_PERCENT_UNIQUE = {
    ...
    "Set 2 - Electro House & Peak-Time (Side A)": [
        ...
        "Show Me Love", "For Sale", "Never Say Never", "A Bit Patchy"
    ],
    "Set 6 - Electro & Dirty Club Anthems (Side B)": [
        "Perfect Exceeder", "Yeah Yeah", "Let Me Think About It", "The Creeps",
...
async def build_and_verify_zero_duplicates():
    print("=== Reconstruyendo 16 Sets con CERO duplicados ===")
    for name, track_list in SETS_100_PERCENT_UNIQUE.items():
...
if __name__ == "__main__":
    asyncio.run(build_and_verify_zero_duplicates())
