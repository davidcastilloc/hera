"""Calibrador milimétrico para Sets 9 al 16 (Era 2005-2010) entre 74.0 y 78.5 minutos."""
...
CALIBRATED_SETS = {
    # Set 9 (Progressive House Side A - Calibrado a ~77m)
    ...
    # Set 13 (Progressive House Side B - Calibrado a ~76m)
    "Set 13 - Progressive House & Deep Anthems (Side B)": [
        ...
        "Open Your Heart", "Dynasty", "Show Me Love"
    ],

    # Set 10 (French Electro Side A - Calibrado a ~76m)
    "Set 10 - French Electro & Bloghouse (Side A)": [
        ...
        "Illmerica", "Kick Out The Epic", "Genesis", "Positif", "Oi Oi Oi"
    ],

    # Set 14 (French Electro Side B - Calibrado a ~76m)
    "Set 14 - Dirty Dutch & Club Bilde (Side B)": [
        "We Are Your Friends", "Heads Will Roll", "Barbra Streisand",
        "Hello", "Nightcall", "aNYway",
        "Pogo", "Poison Lips", "Hey Boy Hey Girl", "Babylon",
        "Turbulence", "Pop The Glock", "Motor", "Illmerica", "Riverside", "Heartbreaker"
    ],

    # Set 11 (Trance Sensation Side A - 11 himnos extendidos de ~7m = ~76m)
    ...
    # Set 15 (Trance Sensation Side B - 11 himnos extendidos de ~7m = ~76m)
    ...
    # Set 12 (Commercial Dance Side A - Calibrado a ~76m)
    ...
    # Set 16 (Commercial Dance Side B - Calibrado a ~76m)
    "Set 16 - European Club Hits & Vocal Anthems (Side B)": [
        ...
        "No Superstar", "What Is Love 2K9", "Release Me", "Cry Cry", "When The Sun Comes Down", "Everytime We Touch"
    ]
}

async def calibrate():
    for name, tracks in CALIBRATED_SETS.items():
        s_folder = Path("sets") / name
        if s_folder.exists():
            shutil.rmtree(s_folder)
        await create_or_update_dj_set(name, tracks)
